...
import PublishingOverlay from '../components/common/PublishingOverlay';
...
function Upload() {
    ...
    useEffect(() => {
        ...
        const handleBeforeUnload = event => {
            ...
            // Most browsers show their own generic message regardless of
            // what's set here, but a return value is required to trigger it.
            event.returnValue = '';
        };
    ...
    useEffect(() => {
        ...
        // beforeunload doesn't fire for in-app back/forward navigation, so
        // neutralize it separately: push a duplicate history entry, and if
        // Back/Forward still fires while we're uploading, immediately push
    ...
    return (
        <div className="mx-auto max-w-2xl">
            <h1 className="text-xl font-bold text-slate-900 dark:text-white">Upload a video</h1>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="mt-6 space-y-5">
                <fieldset disabled={uploadMutation.isPending} className="space-y-5">
                    {/* Video file */}
                    <div>
                        <button
                            type="button"
            ...
            <PublishingOverlay isOpen={uploadMutation.isPending} progress={uploadProgress} />
        </div>
    );
}
